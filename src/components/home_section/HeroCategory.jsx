...
const HeroCategory = () => {
  ...
  return (
    ...
    <div className="flex flex-wrap text-center gap-2 mx-auto h-[15rem] justify-center lg:hidden md:hidden">
    ...
    <div className="flex text-center gap-2 w-[1300px] h-[15rem] justify-evenly max-lg:hidden">
